...
public class LocationAwareContentHandlerTest
{
    ...
    public void doctypeInformationTest() throws IOException, SAXException
    {
        ...
        assertEquals("http://www.objectweb.org/jonas/dtds/jonas-web-app_3_1.dtd",docType.getSystemId());
        assertEquals("-//ObjectWeb//DTD JOnAS Web App 3.1//EN",docType.getPublicId());
    }
